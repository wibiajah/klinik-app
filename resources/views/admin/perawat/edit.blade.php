        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.data-perawat.update', $perawat) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <!-- Data Pribadi -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama_perawat') is-invalid @enderror" 
                                               id="nama_perawat" name="nama_perawat" value="{{ old('nama_perawat', $perawat->nama_perawat) }}" required>
                                        @error('nama_perawat')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" 
                                               id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $perawat->tanggal_lahir->format('Y-m-d')) }}" required>
                                        @error('tanggal_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tingkat_pendidikan') is-invalid @enderror" 
                                            ...
                                            <option value="D3 Keperawatan" {{ old('tingkat_pendidikan', $perawat->tingkat_pendidikan) == 'D3 Keperawatan' ? 'selected' : '' }}>D3 Keperawatan</option>
                                            <option value="S1 Keperawatan" {{ old('tingkat_pendidikan', $perawat->tingkat_pendidikan) == 'S1 Keperawatan' ? 'selected' : '' }}>S1 Keperawatan</option>
                                            <option value="Ners" {{ old('tingkat_pendidikan', $perawat->tingkat_pendidikan) == 'Ners' ? 'selected' : '' }}>Ners</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('no_str') is-invalid @enderror" 
                                               id="no_str" name="no_str" value="{{ old('no_str', $perawat->no_str) }}" required>
                                        @error('no_str')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($perawat->foto)
                                            <div class="mb-2">
                                                <img src="{{ Storage::disk('public')->url($perawat->foto) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" 
                                               id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $perawat->no_telepon) }}" required>
                                        @error('no_telepon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            @php
                                ...
                                $jadwalKerja = $perawat->jadwal_kerja ?? [];
                            @endphp

                            @foreach($hari as $key => $value)
                            @php
                                $jadwalHari = $jadwalKerja[$key] ?? null;
                                $isChecked = !empty($jadwalHari);
                                $jamMulai = old("jam_mulai_{$key}", $jadwalHari['jam_mulai'] ?? '');
                                $jamSelesai = old("jam_selesai_{$key}", $jadwalHari['jam_selesai'] ?? '');
                                $shift = old("shift_{$key}", $jadwalHari['shift'] ?? '');
                            @endphp
                            <div class="row mb-3">
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               {{ old("jadwal_{$key}") ? (old("jadwal_{$key}") ? 'checked' : '') : ($isChecked ? 'checked' : '') }}>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('status_aktif', $perawat->status_aktif) ? 'checked' : '' }}>
