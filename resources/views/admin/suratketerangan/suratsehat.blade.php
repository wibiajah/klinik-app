<x-admin-layout>
    <x-slot name="title">Template Surat Sehat</x-slot>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800">Template Surat Sehat</h1>
                <p class="text-muted">Kelola template dan cetak surat keterangan sehat</p>
            </div>
            <div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mb-3">
                            <a href="{{ route('admin.suratketerangan.cetak', 'sehat') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="list-unstyled small">
                                <li><strong>Jenis:</strong> Surat Sehat</li>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <button type="button" class="btn btn-outline-primary btn-sm" id="previewPdfBtn">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('admin.suratketerangan.suratsakit') }}" class="btn btn-outline-secondary btn-sm">
                                    <i class="fas fa-file-medical"></i> Template Surat Sakit
                                </a>
    ...
    .catch(error => {
        ...
        alert('Terjadi kesalahan saat menyimpan template: ' + error.message);
            ...
            document.getElementById('previewPdfBtn').addEventListener('click', function() {
                window.open('{{ route("admin.suratketerangan.cetak", "sehat") }}', '_blank');
            });
            ...
            document.getElementById('cetakSuratBtn').addEventListener('click', function(e) {
                ...
                if (confirm('Cetak surat keterangan sehat kosong?')) {
