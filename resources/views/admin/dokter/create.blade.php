<x-admin-layout>
    <div class="container-fluid">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.data-dokter.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" 
                                       id="nama_dokter" name="nama_dokter" value="{{ old('nama_dokter') }}" required>
                                @error('nama_dokter')
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" 
                                           id="status_aktif" name="status_aktif" {{ old('status_aktif', true) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3">
                                        <div class="card">
                                            <div class="card-body p-3">
                                                ...
                                                <div class="jadwal-time" id="time_{{ $key }}" style="display: none;">
                                                    <div class="row">
                                                        <div class="col-6">
