<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Tambah Peralatan {{ ucfirst(str_replace('-', ' ', $kategori)) }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="mb-0">Form Tambah Peralatan</h4>
                    ...
                    <form action="{{ route('admin.biaya-peralatan.store', $kategori) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nomor_seri') is-invalid @enderror" 
                                                   id="nomor_seri" name="nomor_seri" value="{{ old('nomor_seri') }}">
                                            @error('nomor_seri')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('tahun_pembelian') is-invalid @enderror" 
                                                   id="tahun_pembelian" name="tahun_pembelian" value="{{ old('tahun_pembelian') }}" 
                                                   min="1900" max="{{ date('Y') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control @error('biaya_operasional') is-invalid @enderror" 
                                                       id="biaya_operasional" name="biaya_operasional" value="{{ old('biaya_operasional') }}" 
                                                       min="0" step="0.01" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control @error('biaya_perawatan') is-invalid @enderror" 
                                                       id="biaya_perawatan" name="biaya_perawatan" value="{{ old('biaya_perawatan') }}" 
                                                       min="0" step="0.01" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_maintenance_selanjutnya') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('tanggal_maintenance_selanjutnya') }}">
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            // Tampilkan total jika ada element untuk menampilkannya
            const totalElement = document.getElementById('total-biaya');
            if (totalElement) {
